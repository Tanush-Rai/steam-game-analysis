...
Data comes from the [Steam Games Dataset](https://www.kaggle.com/datasets/fronkongames/steam-games-dataset) (~126,000 games), scraped from the Steam API. Project files are in the `steam_project` folder.
...
## What's in the steam_project folder
